import {
  ...
  getVector3,
  getWeights
} from "./chunk-ZNXQNGD2.js";
import {
  FlowGraphGLTFDataProvider
} from "./chunk-3TTBVCUU.js";
import {
  AnimationEvent,
  AssetContainer,
  DataReader,
...
import {
  PBRMaterial
} from "./chunk-WQYKKCQR.js";
import {
  RenderTargetTexture,
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-FMUBQN3K.js";
import {
  HemisphericLight,
...
var GLTFLoader2 = class _GLTFLoader {
  ...
  loadAnimationAsync(context, animation) {
    ...
    return import("./animationGroup-WGW4P6FL.js").then(({ AnimationGroup }) => {
      this._babylonScene._blockEntityCollection = !!this._assetContainer;
  ...
  async _loadAnimationChannelAsync(context, animationContext, animation, channel, onLoad) {
    ...
    await import("./glTFLoaderAnimation-MO6ULWXU.js");
    let properties;
...
addToBlockFactory(NAME32, "FlowGraphGLTFDataProvider", async () => {
  return (await import("./flowGraphGLTFDataProvider-AGE2QZ3L.js")).FlowGraphGLTFDataProvider;
});
...
//# sourceMappingURL=chunk-B34OTMW7.js.map
