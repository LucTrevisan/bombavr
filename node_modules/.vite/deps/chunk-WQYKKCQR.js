    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-JNU5K7BF.js"), import("./pbr.fragment-NEVJMJ7Z.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-MRANU5GT.js"), import("./pbr.fragment-UN4NSN4A.js")]);
        }
...
//# sourceMappingURL=chunk-WQYKKCQR.js.map
