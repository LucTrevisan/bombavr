import {
  EffectWrapper
} from "./chunk-CXJKXXPX.js";
import {
  PostProcessManager,
  RenderingManager
} from "./chunk-SKN6UNKL.js";
import {
  PerfCounter
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-YNZQBOPV.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-MEW2WQT5.js");
    const textures = [];
...
//# sourceMappingURL=chunk-FMUBQN3K.js.map
